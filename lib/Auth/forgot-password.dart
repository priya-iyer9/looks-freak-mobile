...
class _ResetPasswordState extends State<ResetPassword> {
  ...
  resetPassword() async {
    if (resetEmailController.value.text.trim().length == 0) {
      ...
      widget.server
          .forgotPassword(resetEmailController.value.text.trim())
          .then((val) {
            ...
            child: Column(
                ...
                children: [
                  ...
                  Padding(
                      padding: EdgeInsets.all(12),
                      child: Text(
                          "Password reset email sent to ${resetEmailController.value.text.trim()}",
              ...
              children: [
                ...
                Padding(
                  ...
                  child: GestureDetector(
                    onTap: () => resetPassword(),
                    child: PrimaryButton(title: "Reset"),
                  ),
                )
              ],
            ),
